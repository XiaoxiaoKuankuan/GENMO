...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--joint-limit-tolerance-rad", type=float, default=0.576)
    parser.add_argument("--max-joint-velocity-radps", type=float, default=25.92)
    parser.add_argument("--max-root-linear-velocity-mps", type=float, default=5.76)
    parser.add_argument("--max-root-angular-velocity-radps", type=float, default=14.4)
...
class BumiOnlineBridge:
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.idle_qpos = (
            self.kinematics.make_standing_qpos(
